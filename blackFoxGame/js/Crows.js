...
const collisionCanvas = $.getElementById(`collisionCanvas`)
...
class Raven {
    constructor() {
        ...
        this.sizeModifire = Math.random() * 0.6 + 0.4
...
window.addEventListener(`click`, function(e) {
    ...
    const detectPixelColor = collisionCtx.getImageData(e.clientX - canvasPosition.left, e.clientY - canvasPosition.top, 1, 1);
...
function animate(timestamp) {
    ...
    particels = particels.filter(object => !object.markedForDeletion)
